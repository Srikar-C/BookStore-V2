package com.bookstore.CommonService.AOP;
...
import com.bookstore.CommonService.controller.CommonController;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.bookstore.CommonService.controller..*(..))")
